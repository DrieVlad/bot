...
public class Tests 
{
	...
	public void testHelp() 
	{
		...
		assertEquals(check_help, true);
		check_help = Skeleton.help("ѕомоги");
		assertEquals(check_help, true);
		check_help = Skeleton.help("помощь");
		assertEquals(check_help, true);
		check_help = Skeleton.help("ѕомощь");
		assertEquals(check_help, true);
		check_help = Skeleton.help("–асскажи о себе");
		assertEquals(check_help, true);
	...
	public void testCheckWordDictionary() {
		...
		assertEquals(accessoryTowns.checkWordDictionary("јбаза", usedCities), false);
		assertEquals(accessoryTowns.checkWordDictionary("јбакан", usedCities), true);
	}
