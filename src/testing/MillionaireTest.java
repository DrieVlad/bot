...
public class MillionaireTest {
	...
	{
		assertEquals("Попробуйте ввести цифру от 1⃣ до 4⃣.", millionaire.gameNext("25"));	
		assertEquals("Попробуйте ввести цифру от 1⃣ до 4⃣.", millionaire.gameNext("lalala"));
	}
	...
	public void winMillionaireTest()
	{
		...
		Millionaire.level = 4;
		assertEquals("Вы выиграли 300 очков, в следующий раз получится лучше!😉👌 \n Ещё разок?😏  Отвечай \'да\'👍 или \'нет\'👎", millionaire.gameNext("1"));	
		Millionaire.level = 2;
		millionaire.ask.trueAnswer = 4;
		assertEquals("Вы ничего не выиграли!😣 Ещё разок?😏 Отвечай \'да\'👍 или \'нет\'👎", millionaire.gameNext("4"));
	}
}